...
<body class="bg-white text-agri-dark antialiased font-sans">
    ...
    <header class="bg-white/80 backdrop-blur-sm sticky top-0 z-50 shadow-sm">
        <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="#" class="flex items-center space-x-3">
                <img src="https://2.bp.blogspot.com/-YOMXduQjo2g/VPUW-ZEttsI/AAAAAAAABi0/ggC1LSO0Lng/s1600/LOGO+KABUPATEN+MAPPI,+PAPUA.png"
                    alt="Logo Kabupaten Mappi" class="h-9 w-9">
                <span class="text-lg font-semibold text-agri-dark tracking-wide">Komoditas Pertanian Mappi</span>
            </a>
            <div class="hidden md:flex items-center space-x-8">
                <a href="#home"
                    class="text-slate-600 hover:text-agri-green-dark transition-colors duration-300">Beranda</a>
                <a href="#insights"
                    class="text-slate-600 hover:text-agri-green-dark transition-colors duration-300">Wawasan Data</a>
                <a href="#map-section"
                    class="text-slate-600 hover:text-agri-green-dark transition-colors duration-300">Peta Digital</a>
            </div>
            <div class="md:hidden">
        ...
        <div id="mobile-menu" class="mobile-menu md:hidden bg-white border-t border-gray-200">
            <div class="px-6 pt-2 pb-4 space-y-2">
                <a href="#home"
                    class="nav-link-mobile block text-slate-600 hover:bg-agri-green-light rounded-md py-2 px-3">Beranda</a>
                <a href="#insights"
                    class="nav-link-mobile block text-slate-600 hover:bg-agri-green-light rounded-md py-2 px-3">Wawasan
                    Data</a>
                <a href="#map-section"
                    class="nav-link-mobile block text-slate-600 hover:bg-agri-green-light rounded-md py-2 px-3">Peta
                    Digital</a>
            </div>
        </div>
    </header>
    ...
    <main>
        <section id="home" class="relative bg-cover bg-center min-h-[90vh] flex items-center justify-center"
            style="background-image: url('https://images.unsplash.com/photo-1560493676-04071c5f467b?q=80&w=1974&auto=format&fit=crop');">
            ...
            <div class="container mx-auto px-6 text-center relative z-10 -mt-16">
                <h1
                    class="text-4xl md:text-6xl font-extrabold text-white leading-tight mb-4 animate__animated animate__fadeInDown">
                    <span class="text-agri-green">Data Cerdas</span> untuk Pertanian Mappi
                </h1>
                <p
                    class="text-lg md:text-xl text-slate-200 max-w-3xl mx-auto mb-8 animate__animated animate__fadeInUp animate__delay-1s">
                    Jelajahi data dan analisis real-time untuk memberdayakan petani, mengoptimalkan sumber daya, dan
                    membangun ketahanan pangan di Kabupaten Mappi.
                </p>
                <a href="#map-section"
                    class="bg-agri-green hover:bg-agri-green-dark text-white font-bold py-4 px-8 rounded-full text-lg transition-all duration-300 inline-flex items-center space-x-2 shadow-lg hover:shadow-xl hover:scale-105 transform animate__animated animate__pulse animate__delay-2s">
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div id="map-section" class="pt-16">
                    <div class="text-center mb-12">
                        ...
                        <p class="text-slate-500 mt-2 text-lg">Visualisasi geospasial sebaran komoditas di Kabupaten
                            Mappi.</p>
                    </div>
        ...
        <section id="analysis" class="py-24 bg-agri-green-light">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-slate-500 mt-2 text-lg">Lihat lebih dalam distribusi komoditas dan data berdasarkan
                        waktu.</p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-12">
                    ...
                    <div
                        class="lg:col-span-2 bg-white rounded-2xl shadow-lg p-8 flex flex-col justify-center border border-gray-100">
                        ...
                        <form action="{{ route('home') }}" method="GET" class="space-y-4">
                            <div>
                                ...
                                <select name="year" id="year"
                                    class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-agri-green focus:border-agri-green p-3">
                            ...
                            <div class="pt-2">
                                <button type="submit"
                                    class="w-full bg-agri-green text-white font-bold py-3 px-4 rounded-lg hover:bg-agri-green-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-agri-green transition-all duration-300 flex items-center justify-center">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    @forelse($groupedData as $kecamatan => $komoditas)
                        <div
                            class="kecamatan-card bg-white rounded-2xl shadow-lg overflow-hidden h-full flex flex-col border border-gray-100 animate__animated animate__fadeInUp">
                            <div class="p-6">
                                <h5 class="text-xl font-bold text-center text-agri-dark-light mb-5">{{ $kecamatan }}</h5>

                                <div class="mb-5">
                                    <ul class="flex justify-center bg-gray-100 p-1.5 rounded-lg"
                                        id="kecamatanTab-{{ Str::slug($kecamatan) }}" role="tablist">
                                        <li class="w-1/2" role="presentation">
                                            <button class="w-full text-center p-2 rounded-md transition-colors duration-300"
                            ...
                            <div class="tab-content px-6 pb-6 flex-grow"
                                id="kecamatanTabContent-{{ Str::slug($kecamatan) }}">
                                            ...
                                            <tbody class="divide-y divide-gray-200">
                                                @foreach($komoditas as $i => $w)
                                                    <tr class="hover:bg-gray-50">
                                                        ...
                                                        <td class="px-6 py-4 text-right">{{ number_format($w->total_luas, 2) }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                    ...
                    @empty
                        <div
                            class="lg:col-span-2 bg-sky-100 border-l-4 border-sky-500 text-sky-800 p-6 rounded-r-lg shadow-md text-center">
                            <i class="bi bi-info-circle text-2xl mr-3"></i>
                            <p class="font-semibold">Tidak ada data komoditas yang ditemukan untuk filter yang Anda pilih.
                            </p>
                        </div>
                    @endforelse
                </div>
        ...
        <div class="container mx-auto px-6 py-16">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                <div class="md:col-span-2">
                    ...
                    <p class="text-sm text-slate-400 max-w-md">Memberdayakan masa depan pertanian Kabupaten Mappi
                        melalui transparansi dan solusi data cerdas untuk kesejahteraan bersama.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-slate-400">
                        <li class="flex items-start"><i
                                class="bi bi-geo-alt-fill mr-3 mt-1 text-agri-green"></i><span>Jl. Poros, Kepi,
                                Kabupaten Mappi, Papua Selatan</span></li>
                        <li class="flex items-center"><i
                                class="bi bi-envelope-fill mr-3 text-agri-green"></i><span>kontak@pertanianmappi.go.id</span>
                        </li>
                    </ul>
                </div>
            </div>
