...
$wilayahQuery = WilayahPertanian::with(['kecamatan', 'komoditas']);
        ...
        $query = WilayahPertanian::join('kecamatans', 'wilayah_pertanian.kecamatan_id', '=', 'kecamatans.kecamatan_id')
            ->join('komoditas', 'wilayah_pertanian.komoditas_id', '=', 'komoditas.id') // 🔹 join tabel komoditas
            ->select(
                'kecamatans.nama_kecamatan',
                'komoditas.nama as nama_komoditas', // 🔹 ambil nama komoditas dari tabel komoditas
